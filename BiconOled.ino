...
const char* ssid = "SaturatedCRM";      // Your WiFi SSID
const char* password = "omomomom";      // Your WiFi Password

const char* googleScriptURL = "https://script.google.com/macros/s/AKfycbyIcVCu4ifewb6hCPfzdrSGahAQsQXpdZceWLL64ng0HLiUKu1532ydgCMMXVvHn4PSZw/exec";
